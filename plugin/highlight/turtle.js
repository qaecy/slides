// https://github.com/highlightjs/highlightjs-turtle/blob/master/src/turtle.js
...
export function turtle(hljs){
    ...
    const APOS_STRING_LITERAL = JSON.parse(
      JSON.stringify(hljs.APOS_STRING_MODE)
    );
    APOS_STRING_LITERAL.relevance = 0;

    const QUOTE_STRING_LITERAL = JSON.parse(
      JSON.stringify(hljs.QUOTE_STRING_MODE)
    );
